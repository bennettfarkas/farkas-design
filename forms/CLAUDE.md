...
- **Notion properties**: `Email` (email), `Signed Up` (date), `Source` (select: "farkas.design signup"), `Message` (rich_text, optional — included when the contact form has a message)
